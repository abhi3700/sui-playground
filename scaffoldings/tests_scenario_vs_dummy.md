---
title: Test Scenario vs Dummy Context
---

Two reasons found so far:

1. If we want to change the sender (caller) for multiple transactions in order to test a functionality
2. If we want to get/collect/read an object(s) created from last transaction made by the sender. Below is an example:
